						...
						<div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
							<div className="max-w-2xl">
								...
								<p className="mt-4 text-base leading-8 text-[#785E61]/78">
									Cada peça nasce para traduzir afeto, memória e beleza em
									madeira. Explore alguns estilos que podem inspirar o seu
									pedido.
								</p>
							</div>
				...
				<section className="px-5 pb-24 sm:px-8 lg:px-10">
					<div className="mx-auto max-w-6xl rounded-[2.3rem] bg-[#785E61] px-6 py-12 text-center text-[#FAFAFA] shadow-[0_30px_80px_rgba(120,94,97,0.16)] sm:px-10 lg:px-16">
						...
						<p className="mx-auto mt-4 max-w-4xl text-[0.98rem] leading-7 text-[#FAFAFA]/82 sm:text-lg sm:leading-8">
							Criamos placas personalizadas em madeira para presentes, decoração
			...
			>
				...
				<div className="mx-auto mt-10 max-w-7xl border-t border-[#785E61]/12 pt-6 text-center">
					<a
						...
						target="_blank"
						rel="noreferrer"
						className="text-sm font-medium text-[#785E61] transition hover:text-[#785E61]/70"
					>
